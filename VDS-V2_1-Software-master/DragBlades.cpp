...
void DragBladesClass::motorTest()
{
	...
	Serial.println("OUTWARD MOTOR DO COMPLETED");
	...
	Serial.println("INWARD MOTOR DO COMPLETED");
	if ((Serial.available() > 0) || ((millis() - timer) >4000)) {
	motorDont();
	return;
	}
	...
	Serial.println("MOTOR HAS BEEN TO 25");
	/*motorDont();
	delay(300);
	motorGoToPersistent(25);
	motorGoToPersistent(50);
	Serial.println("MOTOR HAS BEEN TO 50");
	motorDont();
	delay(300);
	motorGoToPersistent(50);
	motorGoToPersistent(75);
	Serial.println("MOTOR HAS BEEN TO 75");
	motorDont();
	delay(300);
	motorGoToPersistent(75);
	motorGoToPersistent(100);
	Serial.println("MOTOR HAS BEEN TO 100");
	motorDont();
	delay(300);
	motorGoToPersistent(100);
	motorGoToPersistent(75);
...
void DragBladesClass::motorGoToPersistent(uint16_t goToPercent)
{
	...
	motorGoTo(map(goToPercent, 0, 100, encMin, encMax));
